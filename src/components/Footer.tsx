        ...
        <div className="grid grid-cols-2 gap-x-12 gap-y-16 md:col-span-3 lg:grid-cols-6">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            ...
            <p className="mt-7 text-base leading-relaxed text-muted-foreground">
              ...
              quas rerum sapiente accusantium laudantium sed esse ullam? Enim,
              quis dicta modi amet natus fuga inventore reprehenderit soluta
              necessitatibus! Sequi, voluptates!
            </p>
            ...
            <ul className="mt-6 space-y-4">
              <li>
                <a
                  href="#"
                  title=""
                  className="flex text-sm transition-all duration-200 hover:text-primary focus:text-primary"
                >
                  {" "}
                  O nás{" "}
                </a>
